...
export default function Contact() {
    return (
        <Layout>
            <section className="max-w-5xl mx-auto grid grid-cols-1 gap-8 mt-20 p-4">
                <h2 className="text-5xl lg:text-7xl font-black drop-shadow-xl text-center">{copy.team.title}</h2>
                <img src={images.team.hero} alt="Stanford Running Club Team" className="w-full h-full object-cover rounded max-w-3xl mx-auto" />
                ...
                <div className="text-neutral-500 flex items-center justify-center gap-8 text-center max-w-xl mx-auto">
                    {copy.team.subtitle}
                </div>
            </section>
            <section className="grid grid-cols-1 lg:grid-cols-2 max-w-7xl mx-auto my-20 p-4">
            ...
            <section className="max-w-5xl mx-auto grid grid-cols-1 gap-8 p-4">
                ...
                <img src={images.team.records} alt="Stanford Running Club at NIRCA Nationals" className="w-full h-full object-cover rounded max-w-xl mx-auto" />
